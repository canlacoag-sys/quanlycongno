...
<script>
  ...
  window.APP.routes.khachhang_ajax_edit = "<?= site_url('khachhang/ajax_edit') ?>"; // nếu có
  window.APP.routes.khachhang_ajax_add = "<?= site_url('khachhang/ajax_add') ?>"; // nếu có
  window.APP.routes.khachhang_ajax_delete = "<?= site_url('khachhang/ajax_delete') ?>"; // nếu có
</script>
