<div class="modal fade" id="delDonHangModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title"><i class="fas fa-trash-alt mr-2"></i>Xoá đơn hàng</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnConfirmDeleteDonHang" class="btn btn-danger">Xoá đơn hàng</button>
      </div>
    </div>
  </div>
</div>
